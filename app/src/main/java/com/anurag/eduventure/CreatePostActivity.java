...
import com.anurag.eduventure.databinding.ActivityCreatePostBinding;
...
public class CreatePostActivity extends AppCompatActivity {
    ...
    private String postText, name, profileImage;
    ...
    private void postFeed() {
        ...
        if (image_uri == null) {
            ...
            String filePathAndName = "feeds_images/" + "" + timestamp;
                            ...
                            if (uriTask.isSuccessful()) {
                                ...
                                ref.child("" + timestamp)
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                progressDialog.dismiss();
                                                Toast.makeText(CreatePostActivity.this, " Failed to upload due to" + e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        Toast.makeText(CreatePostActivity.this, "Cancelled", Toast.LENGTH_SHORT).show();
                    }
