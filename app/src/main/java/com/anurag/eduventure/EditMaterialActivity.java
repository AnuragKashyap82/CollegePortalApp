...
import com.anurag.eduventure.databinding.ActivityEditMaterialBinding;
...
public class EditMaterialActivity extends AppCompatActivity {
        ...
        ref.child(branch).child(semester).child(materialId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        topic = ""+snapshot.child("topicName").getValue();
                        subject = ""+snapshot.child("subjectName").getValue();
    ...
    private void validateData() {
        ...
        subject = binding.subNameEt.getText().toString().trim();
        topic = binding.subTopicEt.getText().toString().trim();
