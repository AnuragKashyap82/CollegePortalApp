...
import com.anurag.eduventure.databinding.ActivityMaterialViewBinding;
...
public class MaterialViewActivity extends AppCompatActivity {
    ...
    ActivityMaterialViewBinding binding;
    private FirebaseAuth firebaseAuth;
    private String materialId, topic, semester, branch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityMaterialViewBinding.inflate(getLayoutInflater());
                ...
                if(isDeleteMaterialEnabled) {
                    binding.deleteMaterialBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(MaterialViewActivity.this);
                    ...
                    binding.deleteMaterialBtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Toast.makeText(MaterialViewActivity.this, "This Features is Temporarily disabled...!", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
        ...
        binding.editMaterialBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MaterialViewActivity.this, EditMaterialActivity.class);
                intent.putExtra("materialId", materialId);
                intent.putExtra("branch", branch);
                intent.putExtra("semester", semester);
                startActivity(intent);
                Toast.makeText(MaterialViewActivity.this, "Edit Material Btn Clicked....!", Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        reference.child(branch).child(semester).child(materialId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(MaterialViewActivity.this, "Material Deleted...!", Toast.LENGTH_SHORT).show();
                        deleteFromFavorites();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MaterialViewActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void deleteFromFavorites() {
        ...
        ref.child(FirebaseAuth.getInstance().getUid()).child("Favorites").child(materialId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
                        Toast.makeText(MaterialViewActivity.this, "Deleted from Favorites also....!", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                        ...
                        binding.materialPdfView.fromBytes(bytes)
                                ...
                                .onError(new OnErrorListener() {
                                    ...
                                    public void onError(Throwable t) {
                                        Toast.makeText(MaterialViewActivity.this, ""+t.getMessage(), Toast.LENGTH_SHORT).show();
                                ...
                                .onPageError(new OnPageErrorListener() {
                                    ...
                                    public void onPageError(int page, Throwable t) {
                                        Toast.makeText(MaterialViewActivity.this, "Error on page"+page+" "+t.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .load();
